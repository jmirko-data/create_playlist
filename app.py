...
<style>
:root{--bg:#0f172a;--card:#0b1220;--accent:#7c3aed;--muted:#9aa4b2}
html,body{height:100%;margin:0;font-family:Inter, ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial}
body{background:linear-gradient(180deg, #081028 0%, #071125 60%);display:flex;align-items:center;justify-content:center;color:#e6eef8}
.card{background:rgba(255,255,255,0.03);border-radius:16px;padding:36px;box-shadow:0 8px 30px rgba(2,6,23,0.6);max-width:760px;width:92%;text-align:center}
h1{font-size:clamp(24px,4vw,44px);margin:0 0 12px}
p.lead{margin:0 0 18px;color:var(--muted)}
.pill{display:inline-block;padding:10px 18px;border-radius:999px;background:linear-gradient(90deg, rgba(124,58,237,0.12), rgba(59,130,246,0.06));border:1px solid rgba(124,58,237,0.18);font-weight:600}
footer{margin-top:18px;color:var(--muted);font-size:13px}
.actions{margin-top:20px;display:flex;gap:10px;justify-content:center}
a.btn{padding:10px 16px;border-radius:10px;text-decoration:none;font-weight:600}
a.primary{background:var(--accent);color:white}
a.ghost{background:transparent;border:1px solid rgba(255,255,255,0.06);color:var(--muted)}
</style>
</head>
<body>
<div class=\"card\" role=\"main\">
<h1>FULL PLAYLIST, KISSES</h1>
<p class=\"lead\">This page represents the output returned from a simple Flask interaction.</p>
...
<div class=\"actions\">
<a class=\"btn primary\" href=\"/playlist\">Reload</a>
<a class=\"btn ghost\" href=\"/\">Homepage</a>
</div>


<footer>
<small>Generated by a simple Flask endpoint — edit the message in the code if you want a different version.</small>
</footer>
</div>
</body>
</html>
